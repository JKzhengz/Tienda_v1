...
public class RegistroServiceImpl implements RegistroService {
    ...
    @Autowired
    private MessageSource messageSource;  //creado en semana 4. Lo que se encuentra en los messages
    @Autowired
    ...
    public Model activar(Model model, String username, String clave) {
        ...
        if (usuario != null) {
            ...
            model.addAttribute(
                    "mensaje", 
                    messageSource.getMessage(
                            "registro.activar.error", //la persona ya existe en la base de datos
                            null, Locale.getDefault()));
        }
        return model;
    }
    ...
    @Override
    public void activar(Usuario usuario, MultipartFile imagenFile) {  //lo sube al firebase
        var codigo = new BCryptPasswordEncoder(); //encripta la contraseño
    ...
    @Override
    public Model crearUsuario(Model model, Usuario usuario)  //regenera la clave si el usuario ya exite
