...
public class ItemServiceImpl implements ItemService {
    ...
    @Override //obtener el carrito completo (mostrar lista de items)
    ...
    public void save(Item item) {
        boolean existe = false; //si ya está en el carrito, add()
    ...
    public void facturar() {
        ...
        String username;
        Object principal = SecurityContextHolder.getContext().getAuthentication().getPrincipal(); // obtiene el contexto
        if (principal instanceof UserDetails userDetails) {
            username = userDetails.getUsername(); //obtiene el nombre
        } else {
        ...
        double total = 0;
        for (Item i : listaItems) {  //todo esto tiene que ver con la base datos
