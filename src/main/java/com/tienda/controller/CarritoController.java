...
public class CarritoController {
    ...
    public ModelAndView agregarItem(Model model, Item item) { //Modelandview, modelo y vista
        ...
        return new ModelAndView("/carrito/fragmentos :: verCarrito"); //desde el controller, de una manera directa
    }
